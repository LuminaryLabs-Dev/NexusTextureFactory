        const NavBar = ({ uiVM }) => (
            <div className="h-12 bg-[#1a1a1a] flex items-center justify-center gap-8 border-b border-gray-800 shrink-0">
                ...
                <button onClick={() => uiVM.setActiveTab('integrations')} className={`tab-btn text-xs font-bold tracking-widest ${uiVM.activeTab === 'integrations' ? 'text-white active' : 'text-gray-500 hover:text-gray-300'}`}>INTEGRATIONS</button>
